 ...
 */
class ToggleMarkOccurrencesHandler extends AbstractToggleHandler("org.scala-ide.sdt.core.toggleMarkOccurences", EditorPreferencePage.EnableMarkOccurrences)
