...
class TestProjectSetup(
    projectName: String,
    srcRoot: String = "/%s/src/",
    containingBundleName: String = "org.scala-ide.sdt.core.tests") extends ProjectBuilder {
  ...
  lazy val project: ScalaProject = SDTTestUtils.setupProject(projectName, containingBundleName)
